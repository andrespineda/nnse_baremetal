...
# SEGGER RTT Module (only include if source files exist)
ifeq ($(wildcard extern/AmbiqSuite/$(AS_VERSION)/third_party/SEGGER/SEGGER_RTT_V680a/RTT/*.c),)
# No SEGGER RTT source files found
else
modules      += extern/AmbiqSuite/$(AS_VERSION)/third_party/SEGGER/SEGGER_RTT_V680a
endif
...
# This is used for tflm_validator, genLib, and power binaries
	...
	ifeq ($(EXAMPLE),all)
		...
		ifeq ($(BLE_SUPPORTED),1)
            ...
            modules      += apps/demos/nnse_baremetal
			modules      += apps/demos/ble
		endif
