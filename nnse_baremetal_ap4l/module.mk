local_app_name := nnse_baremetal_ap4l
local_src := $(wildcard $(subdirectory)/src/*.c)
local_src += $(wildcard $(subdirectory)/src/*.cc)
local_src += $(wildcard $(subdirectory)/src/*.cpp)
local_src += $(wildcard $(subdirectory)/src/*.s)
local_bin := $(subdirectory)/build

# Add neural network library
local_libs := $(subdirectory)/libs/ns-nnsp.a
...
$(eval $(call make-axf, $(local_bin)/$(local_app_name), $(local_src), , $(local_libs)))